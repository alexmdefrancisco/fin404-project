...
def calibration_error(params):
    ...
    # Calculate VIX futures error
    for contract in vix_futures_data:
    ...
    # Calculate Variance futures error
    for contract in variance_futures_data:
...
if __name__ == '__main__':
    ...
    progress_bar = tqdm(desc="Calibrating Parameters", unit=" iter")

    # Define the callback function to update the bar
    ...
    # Print model vs market prices with calibrated parameters
    print("\n--- Model Fit Analysis ---")
    print("\nVIX Futures:")
